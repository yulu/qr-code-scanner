 ...
 */
public abstract class AbstractScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    public AbstractScannerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setupLayout(context);
    }

    public final void setupLayout(Context context) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        layoutInflater.inflate(R.layout.scanner_layout, this, true);

        mPreview = (CameraPreview) findViewById(R.id.camera_preview);
        mViewFinderView = (ViewFinderView) findViewById(R.id.view_finder_view);
    }
